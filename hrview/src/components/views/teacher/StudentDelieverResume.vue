            ...
            <div class="in-layout-content">
              ...
              <div class="resumewrapp">
                ...
                <div class="resumecontent">
                  <li class="presonBase">
                    <img data-v-b8fe8cbc="" src="https://zcplan.oss-cn-shenzhen.aliyuncs.com/man.png" alt=""
                         class="avatar">
                    <div class="baseMes">
                      ...
                      <div class="personal-mes">{{ studentInfo.gender }}<span
                        ...
                        {{ studentInfo.sDepartment }}<span
                            style="margin: 0 14px;color: #e6e6e6">|</span>{{ studentInfo.sMajor }}
                        <span style="margin: 0 14px;color: #e6e6e6">|</span> {{ studentInfo.className }}
                      </div>
                  ...
                  <li class="advantage" v-if="resume.personalAdvantage">
                    ...
                    <div class="advantage-con" v-if="resume.personalAdvantage"><p class="edit-show-content"
                  ...
                  <li>
                    ...
                    <div class="advantage-con" v-if="resume.projectExperience"><p class="edit-show-content"
                                                                                  style="max-width: 718px;">
                  ...
                  <li>
                    ...
                    <div class="advantage-con" v-if="resume.internshipExperience"><p class="edit-show-content"
                                                                                     style="max-width: 718px;">
                  ...
                  <li>
                    ...
                    <div class="advantage-con" v-if="resume.certificate"><p class="edit-show-content"
                                                                            style="max-width: 718px;">
                      {{ resume.certificate }}
                    </p>
                      <div class="fixed-edit">
                  ...
                  <li>
                    ...
                    <div class="advantage-con" v-if="resume.awardExperience"><p class="edit-show-content"
                                                                                style="max-width: 718px;">
