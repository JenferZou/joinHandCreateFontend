        ...
        <div class="layout-search">
            <i-row>
                <i-col :span="12">
                    <i-row>
                        <i-col :span="16" >
                            <el-input @keyup.enter.native="search" size="small" v-model="studentName" placeholder="输入学生名字..." clearable prefix-icon="el-icon-search">
                            </el-input>
                        </i-col>
                        <i-col :span="3">
        ...
        <el-table class="StudentTable"
            ...
            <el-table-column
                ...
                <template v-slot="scope">
                    ...
                    <el-button @click="passStudent(scope.row)" type="text" size="small" style="color:limegreen;">通过</el-button>
                </template>
            </el-table-column>
        </el-table>
...
export default {
    ...
    methods: {
        ...
        multiDelete(){
            this.$http({
                url: this.$http.adornUrl('/teacher/delete'),
                method: 'post',
        ...
        getStudent(){
            ...
            this.$http({
                url: this.$http.adornUrl('/teacher/listStudent'),
                method: 'get',
        ...
        search(){
            if(this.studentName!=='') {
                ...
                this.$http({
                    url: this.$http.adornUrl('/teacher/search'),
                    method: 'get',
                    params: this.$http.adornParams(params),
                    headers: {
                        'UserToken':window.sessionStorage.getItem('Token'),
        ...
        betterSearch(){
            ...
            this.$http({
                url: this.$http.adornUrl('/teacher/highSearch'),
                method: 'get',
